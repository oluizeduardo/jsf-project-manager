...
public class RelatoriosController {
	...
	private String cursoParaComparar = "AdministraÁ„o";
    ...
    public void createVerticalBarModel(){
        ...
        if(lista.isEmpty()){
        	...
        	// Coloca atÈ 5 habilidades no gr·fico.
    ...
    private void createHorizontalBarModel() {
        ...
        if(lista.isEmpty()){
        	serie.set("NinguÈm cadastrou ainda", 0);
        }else{
...
=======
        ...
        serie1.set("Nov", 2);
        serie1.set("Dez", 2);
>>>>>>> parent of affd899... Implementa√ß√£o no gr√°fico de linhas na p√°gina de relat√≥rios.
...
<<<<<<< HEAD
    /**
     * @param mes O n˙mero do mÍs que se deseja saber o nome.
     * @return O nome do mÍs.
     */
